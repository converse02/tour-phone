...
class GidChatFragment : Fragment() {

    private lateinit var binding: TouristChatFragmentBinding

    val adapter = GidChatAdapter()
    ...
    override fun onCreateView(
        ...
        val viewModel = ViewModelProvider(requireActivity())[GidViewModel::class.java]
        ...
        binding.btnSendMsg.setOnClickListener {
            ...
            val name = "Гид ${Bridgefy.getInstance().bridgefyClient.userUuid}"
